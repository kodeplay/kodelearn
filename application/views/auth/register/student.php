     <?php echo $form->startform(); ?>
        <table class="formcontainer">
            ...
            <tr>
                <td class="tar"><?php echo $form->email_parent->label(); ?></td>
                <td>
                    <?php echo $form->email_parent->element(); ?>
                    <span class="form-error"><?php echo $form->email_parent->error(); ?></span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="tar"><?php echo $form->parentname->label(); ?></td>
                <td>
                    <?php echo $form->parentname->element(); ?>
                    <span class="form-error"><?php echo $form->parentname->error(); ?></span>
                </td>
            </tr>
            <tr>
