     <?php echo $form->startform(); ?>
        <table class="formcontainer">
            ...
            <tr>
                <td class="tar"><?php echo $form->email_child->label(); ?></td>
                <td>
                    <?php echo $form->email_child->element(); ?>
                    <span class="form-error"><?php echo $form->email_child->error(); ?></span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="tar"><?php echo $form->childname->label(); ?></td>
                <td>
                    <?php echo $form->childname->element(); ?>
                    <span class="form-error"><?php echo $form->childname->error(); ?></span>
                </td>
            </tr>
            <tr>
