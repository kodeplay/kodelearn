...
<?php if($items_per_page < $total_items){ ?>
	...
	<?php foreach ($links as $number => $content): ?>
		...
		<?php if ($number === $current_page): ?>
			<a class="selected"><?php echo $content ?></a>
		<?php else: ?>
	...
	<?php /*if ($next_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next"><img src="http://projects.kp/kohana/media/images/next.png" title="Next Page"/></a>
	<?php else: ?>
		<img src="http://projects.kp/kohana/media/images/next.png" title="Next Page"/>
	<?php endif*/ ?>
