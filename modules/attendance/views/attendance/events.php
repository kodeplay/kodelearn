            ...
            <?php foreach($lecture_exam_data_all as $lecture_exam_data){ ?>
                <tr>
                    ...
                    <?php if($lecture_exam_data['assigned'] == 'assigned'){ ?>
                        <a href="<?php echo 'attendance/add/id/'.$lecture_exam_data['id'].'/type/'.$lecture_exam_data['eventtype'].'/event_id/'.$lecture_exam_data['event_id']; ?>">Edit Attendance</a>
                    <?php } else { ?>
                        <a href="<?php echo 'attendance/add/id/'.$lecture_exam_data['id'].'/type/'.$lecture_exam_data['eventtype'].'/event_id/'.$lecture_exam_data['event_id']; ?>">Mark Attendance</a>
                    <?php } ?>
                    </td>
                </tr>
